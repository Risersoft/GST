...
Public Class frmGSTNANX02
    Inherits frmMax
    Dim myViewGSTReg, myViewHistory, myViewITCRev, myViewCPSumm As New clsWinView
    ...
    Public Overrides Function PrepForm(oView As clsWinView, ByVal prepMode As EnumfrmMode, ByVal prepIdx As String, Optional ByVal strXML As String = "") As Boolean
        ...
        Dim objModel As frmGSTNANX02Model = Me.InitData("frmGSTNANX02Model", oview, prepMode, prepIdx, strXML)
    ...
    Private Sub DeleteTaxPayerDataToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles DeleteTaxPayerDataToolStripMenuItem.Click
    ...
    Private Sub reBindView(ds As DataSet)
        ...
        myViewITCRev.mainGrid.BindView(ds,, 3)
