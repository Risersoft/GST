...
Public Class frmGstPaymentVendor
    Inherits frmMax
    ...
    Public Overrides Function PrepForm(oView As clsWinView, ByVal prepMode As EnumfrmMode, ByVal prepIdx As String, Optional ByVal strXML As String = "") As Boolean
        ...
        Dim objModel As frmGstPaymentVendorModel = Me.InitData("frmGstPaymentVendorModel", oview, prepMode, prepIdx, strXML)
    ...
    Public Overrides Function BindModel(NewModel As clsFormDataModel, oView As clsView) As Boolean
        If MyBase.BindModel(NewModel, oView) Then
            ...
            myWinSQL.AssignCmb(Me.dsCombo, "POS", "", Me.cmb_SupplyFromTaxAreaID)
    ...
    Private Sub cmb_PartyID_Leave(sender As Object, e As EventArgs) Handles cmb_VendorID.Leave, cmb_VendorID.AfterCloseUp
        ...
        If (Not IsNothing(cmb_VendorID.SelectedRow)) Then
            cmb_SupplyFromTaxAreaID.Value = myUtils.cStrTN(cmb_VendorID.SelectedRow.Cells("TaxAreaID").Value)
            cmb_SupplyFromTaxAreaID.ReadOnly = True
        Else
            cmb_SupplyFromTaxAreaID.ReadOnly = False
        End If
    End Sub
