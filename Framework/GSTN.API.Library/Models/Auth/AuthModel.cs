...
namespace Risersoft.API.GSTN.Auth
{
    ...
    public class OtpTokenRequestModel:OTPRequestModel
    {
        public string otp { get; set; }
    }

      public class PwdTokenRequestModel : OTPRequestModel
    {
  ...
  public class OTPResponseModel
    ...
    {
        //some providers give authtoken (KPMG)
        public string authtoken { get; set; }
        public string auth_token { get; set; }
        public DateTime? auth_token_expires_at { get; set; }
