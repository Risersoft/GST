...
<DataContract>
Public Class frmGstPaymentVendorModel
    ...
    Private Sub InitForm()
        ...
        Me.AddLookupField("SupplyFromTaxAreaID", "POS")
        ...
        sql = "SELECT  VendorID, PartyName, TaxAreaCode, VendorCode, TaxAreaID, GSTRegType, GSTIN FROM  purListVendor() Order By PartyName"
        ...
        Me.AddLookupField("GstAdvanceVouchItem", "i_rt", "gstrate1")
        ...
        Me.AddLookupField("GstAdvanceVouchItem", "c_rt", "gstrate2")
        Me.AddLookupField("GstAdvanceVouchItem", "s_rt", "gstrate2")
        ...
        sql = "Select * from validationrule where doctype='PV' and isnull(isdisabled,0)=0"
    ...
    Public Overrides Function PrepForm(oView As clsViewModel, ByVal prepMode As EnumfrmMode, ByVal prepIDX As String, Optional ByVal strXML As String = "") As Boolean
        Dim sql, strf1 As String, dic As New clsCollecString(Of String), oDoc As New clsGSTAdvanceBase(myContext, "PV", "GSTR2")
        ...
        sql = "Select CampusID, DispName, CompanyID, CampusType,TaxAreaCode, DivisionCodeList, GstRegID, GstRegType, CampusCode, GSTIN, PartialCredit, campuscode, RegDate from mmListCampus() " & str1 & " Order by DispName"
    ...
    Public Overrides Function Validate() As Boolean
        ...
        myFuncs2.CheckPopulateTaxAreaID(myRow.Row, Me.SelectedRow("VendorID"), Nothing)

        Dim CTIN As String = If(Me.SelectedRow("VendorID") Is Nothing, "", myUtils.cStrTN(Me.SelectedRow("vendorid")("gstin")))
        myRow("sply_ty") = myFuncs2.FindSupplyTypePurchase(CTIN, myUtils.cStrTN(Me.SelectedRow("CampusID")("GstRegType")), Me.SelectedRow("POSTaxAreaID"), Me.SelectedRow("SupplyFromTaxAreaID"))
        ...
        For Each str1 As String In New String() {"campus", "gstreg", "party", "returnperiod", "returnperiodbefore", "refund", "pos", "orig", "cdn", "AmendVouchMy", "AmendVouchOrig", "GstRegPP"}
    ...
    Public Overrides Function VSave() As Boolean
        ...
        If Me.Validate Then
            ...
            If Me.CanSave Then
                Dim PaymentDescrip As String = " Payment Vendor No: " & myRow("VouchNum").ToString & ", Dt. " & Format(myRow("Dated"), "dd-MMM-yyyy")
                Try
