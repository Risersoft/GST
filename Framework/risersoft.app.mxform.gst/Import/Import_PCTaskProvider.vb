...
Public Class Import_PCTaskProvider
    Inherits ImportTaskProviderAdvanceBase

    Public Overrides Property RowsNotMatchingCode As Integer = 746
    Public Overrides Property PreValidationErrorCode As Integer = 749
    Public Overrides Property DocType As String = "PC"
    Public Overrides Property TemplateFunctionName As String = "GstListAdvanceVouchTemplate()"

    Public Overrides Property TemplateName As String = "Advance_Receipt_Refund"
    ...
    Public Overrides Async Function TryImportRowGroup(provider As IAppDataProvider, objGroup As clsRowGroup, objPortion As clsPortionInfo) As Task(Of clsProcOutput)
        ...
        If oRet.Success Then
            For Each str1 As String In New String() {"campus", "gstreg", "party", "returnperiod", "returnperiodbefore", "refund", "pos", "orig", "AmendVouchMy", "AmendVouchOrig", "GstRegPP"}
            ...
            If info.Errorcount = 0 Then
                ...
                Try
                    Dim oProc As New clsGSTAdvanceBase(provider, "PC", "GSTR1")
